...
test("the appendix renderer is source-type grouped, collapsed, and linked back without changing PM rendering", async () => {
  const [app, index, source, mirror] = await Promise.all([
    readFile(new URL("app.js", root), "utf8"),
    readFile(new URL("index.html", root), "utf8"),
    readFile(new URL("evidence-appendix-transformer.js", root), "utf8"),
    readFile(new URL("deploy-site/evidence-appendix-transformer.js", root), "utf8"),
  ]);
