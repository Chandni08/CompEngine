...
test("the Seller Assets renderer exposes four gated assets without changing Product Management rendering", async () => {
  const [app, index, mirror] = await Promise.all([
    readFile(new URL("app.js", root), "utf8"),
    readFile(new URL("index.html", root), "utf8"),
    readFile(new URL("deploy-site/seller-assets-transformer.js", root), "utf8"),
  ]);
  ...
  assert.equal(mirror, await readFile(new URL("seller-assets-transformer.js", root), "utf8"));
});
