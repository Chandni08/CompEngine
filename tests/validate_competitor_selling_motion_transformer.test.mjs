...
test("the selling-motion module is mirrored for deployment", async () => {
  const [source, deployed] = await Promise.all([
    readFile(new URL("competitor-selling-motion-transformer.js", root), "utf8"),
    readFile(new URL("deploy-site/competitor-selling-motion-transformer.js", root), "utf8"),
  ]);
