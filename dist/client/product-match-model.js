(function exposeHeadToHeadProductMatchModel(root) {
  ...
  const api = { availableCompetitors, build, candidates, normalize, normalizeCompetitorFilter, positioningTier, productRows, segmentTokens, similarityBasis, techniqueClass };
