...
const DEFAULT_ADMIN_PASSWORD_HASH = "14e3fd9cabc868dc8ead6ca4daea0fdeca90288ce2b4a66d0a47175f31ad127d";
...
function configuredUserId() {
  return process.env.CONFERENCE_ADMIN_USER_ID || DEFAULT_ADMIN_USER_ID;
}

function configuredPasswordHash() {
  return process.env.CONFERENCE_ADMIN_PASSWORD_HASH || DEFAULT_ADMIN_PASSWORD_HASH;
}

function sessionSecret() {
  return process.env.CONFERENCE_ADMIN_SESSION_SECRET || configuredPasswordHash();
}
